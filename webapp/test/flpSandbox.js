		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sopra CI/CD PoC",
									"targetURL": "#comsopracicdpocsopracicdpoc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsopracicdpocsopracicdpoc-display": {
								"semanticObject": "comsopracicdpocsopracicdpoc",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sopra.cicdpoc.sopracicdpoc",
									"url": sap.ui.require.toUrl("com/sopra/cicdpoc/sopracicdpoc")
								}
							}
						}
					}
